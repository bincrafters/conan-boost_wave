...
class TestPackageConan(ConanFile):
    ...
    def requirements(self):
        boost_deps = ['assert', 'concept_check', 'config', 'core', 'filesystem', 'iterator', 'lexical_cast', 'mpl', 'multi_index', 'pool', 'preprocessor', 'serialization', 'smart_ptr', 'spirit', 'static_assert', 'throw_exception', 'type_traits', 'wave']
